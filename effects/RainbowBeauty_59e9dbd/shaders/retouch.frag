...
vec4 sharpen(vec4 originalColor, float factor) {
    vec4 total = 5.0 * originalColor - BNB_TEXTURE_2D_LOD(BNB_SAMPLER_2D(glfx_BACKGROUND), sp0.zw, 0.) - BNB_TEXTURE_2D_LOD(BNB_SAMPLER_2D(glfx_BACKGROUND), sp1.zw, 0.) - BNB_TEXTURE_2D_LOD(BNB_SAMPLER_2D(glfx_BACKGROUND), sp2.zw, 0.) - BNB_TEXTURE_2D_LOD(BNB_SAMPLER_2D(glfx_BACKGROUND), sp3.zw, 0.);
